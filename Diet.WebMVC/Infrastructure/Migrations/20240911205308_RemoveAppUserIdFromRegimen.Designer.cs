...
namespace Diet.WebMVC.Infrastructure.Migrations
{
    ...
    [Migration("20240911205308_RemoveAppUserIdFromRegimen")]
    partial class RemoveAppUserIdFromRegimen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 12, 0, 23, 6, 220, DateTimeKind.Local).AddTicks(418));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 12, 0, 23, 6, 219, DateTimeKind.Local).AddTicks(9716));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.History", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 12, 0, 23, 6, 220, DateTimeKind.Local).AddTicks(1271));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Regimen", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 12, 0, 23, 6, 220, DateTimeKind.Local).AddTicks(1996));
