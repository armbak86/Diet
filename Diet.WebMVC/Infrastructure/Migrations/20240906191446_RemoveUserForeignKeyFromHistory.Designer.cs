...
namespace Diet.WebMVC.Infrastructure.Migrations
{
    ...
    [Migration("20240906191446_RemoveUserForeignKeyFromHistory")]
    partial class RemoveUserForeignKeyFromHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 6, 22, 44, 45, 481, DateTimeKind.Local).AddTicks(2294));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 6, 22, 44, 45, 481, DateTimeKind.Local).AddTicks(1493));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.History", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 6, 22, 44, 45, 481, DateTimeKind.Local).AddTicks(3180));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Regimen", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 6, 22, 44, 45, 481, DateTimeKind.Local).AddTicks(3861));
