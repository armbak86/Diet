...
namespace Diet.WebMVC.Infrastructure.Migrations
{
    ...
    [Migration("20240804093031_UseAppUserInsteadOfIdentityUser")]
    partial class UseAppUserInsteadOfIdentityUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 0, 30, 410, DateTimeKind.Local).AddTicks(2588));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 0, 30, 410, DateTimeKind.Local).AddTicks(1717));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.History", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 0, 30, 410, DateTimeKind.Local).AddTicks(3490));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Regimen", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 0, 30, 410, DateTimeKind.Local).AddTicks(4274));
