...
namespace Diet.WebMVC.Infrastructure.Migrations
{
    ...
    [Migration("20240921170231_AddFileForRegimen")]
    partial class AddFileForRegimen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(4200));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(3242));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.History", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(6373));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.HistoryExerciseItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(5665));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.HistoryFoodItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(4867));
            ...
            modelBuilder.Entity("Diet.WebMVC.Entities.Regimen", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 20, 32, 29, 569, DateTimeKind.Local).AddTicks(7418));
